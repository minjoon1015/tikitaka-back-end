...
public class GetUserMeResponseDto extends ResponseDto {
    ...
    public GetUserMeResponseDto(ResponseCode code, UserInfoDto userInfoDto) {
        super(code);
        this.user = userInfoDto;
    }

    public static ResponseEntity<GetUserMeResponseDto> success(UserInfoDto userInfoDto) {
